...
- **`UrlSyncBlockedResult`**: Typed URL Sync block result. Invalid URL reasons apply to both
  target-origin modes, while `incompatible-site-boundary` remains specific to conservative mode.
