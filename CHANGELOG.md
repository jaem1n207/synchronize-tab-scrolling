# [2.15.0](https://github.com/jaem1n207/synchronize-tab-scrolling/compare/v2.14.2...v2.15.0) (2026-08-15)


### Bug Fixes

* align scroll start protocol destinations ([86b20cb](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/86b20cb02289cd6c44cf1028d84ba3aa4691db57))
* announce degraded suggestion cleanup ([198758d](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/198758dbb44dcd13734376db91262ffdf880f996))
* announce only authoritative quick sync expiration ([b6013ba](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/b6013ba373208701662b2fdf02884571e5b77565))
* announce quick sync assignment changes ([6cc68a1](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/6cc68a1ddfc3a305aad0fe87aaedc5bb7a603f49))
* authorize committed manual session messages ([bffe0d5](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/bffe0d5e56f6d03b254f6cbe3245b8b3a2c3e007))
* authorize content sync display requests ([a0aab58](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/a0aab580214b90819efa805acbf11808a443ba8d))
* authorize exact background relay identities ([7b8c0f4](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/7b8c0f4f11029ad91e9916b11369989b39513092))
* authorize reconnect senders and topology refresh ([ab9e3dc](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/ab9e3dcc3dd8a1daa3732264567bfb53be008240))
* await pending URL sync hint persistence ([afa69c5](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/afa69c5fb4f5e23ba3e547531b2aa4805e2cf644))
* bind sync status source to sender context ([cb41876](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/cb41876f5be7ab4b45c7a9908bf4e02043b99532))
* bound content offset reconciliation ([9d00376](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/9d003765277b029cfe9e1e266fb88e5fc5b0437d))
* call quick sync candidate timer unbound ([63f3784](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/63f378455d80191e580eef64992ed1992b66f85c))
* center quick sync add icon ([1b20ff6](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/1b20ff68cd8ff08a9f2356ec4626ce67f7e59080))
* clean attempted accepted auto starts ([f3228c8](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/f3228c86156e9bddeb2d2dd9099ad3f9e4e6c638))
* clean residual auto sync runtime ([70b580d](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/70b580dc2a5ee7a6ae39b240c029a0bedd878c3d))
* clean up partial quick sync badges ([da8db5e](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/da8db5e7d92418168266b7753a1d8b59716634fc))
* collapse assigned shortcut status ([a5623b2](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/a5623b23d8914e1ecdba44062e914d94e8afd3a4))
* commit quick sync HUD presentation state ([746e717](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/746e7170ef77fe9e12998c0735c3ed0ec5f6f9d7))
* compose popup mutation lock state ([5c141f3](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/5c141f32d5fd655b75f9e701bb15f55960b319d7))
* consume detailed content sync status ([23f56db](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/23f56db471574366f22d091d69b81e0a7c42fa05))
* converge panel URL sync storage ([f1c014c](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/f1c014cfbdc911538b0d26960fc9e06987aca490))
* correct conservative URL sync examples ([e2a3f1f](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/e2a3f1fe1b1f0293b532653a3acd665ef4226fe2))
* deactivate unreconciled content runtimes ([a48f7cb](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/a48f7cb021a426897e1a58f403ff9a90ab978382))
* disable legacy sync status broadcasts ([f514325](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/f5143258265f5155c9316b076eda46635a8a201b))
* disable pending popup menu mutations ([d4f6b0b](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/d4f6b0bb41278c964d00d8280486c92b6c89fb13))
* echo revisions from panel suggestions ([4a2e7c7](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/4a2e7c7fbd26cb20a5c2be7adb5e8d65a3322200))
* echo revisions from suggestion toasts ([4f23697](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/4f236974179d1f885a1e53121dccf3c00a71cac0))
* enforce popup status responses ([9b749e1](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/9b749e1d203761db1bb3ef9b61c7863981b4157b))
* exclude pending overrides from auto groups ([f981673](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/f9816732b0fd18b057252ae7310339b89c92051e))
* expose degraded manual add cleanup ([fdfdbbd](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/fdfdbbdb670eb0cf82e93622a1898ad6e8a63948))
* expose strict manual offset writes ([93e2ab2](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/93e2ab2f70b7555a1f983fae7365e871013cde35))
* follow persisted panel URL sync authority ([7057916](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/7057916a6bf7c24b54394f9b4d662df5ee91a552))
* forward auto sync activation identities ([f2d24eb](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/f2d24ebb2c027afa2229a8a5ec5eae330943edc2))
* gate auto sync handlers on initialization ([ea14169](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/ea14169cb0c6be406b3ff5fcb7d0b0aa43da3016))
* gate auto-sync suggestion display ([090f021](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/090f02103a33b15437c0b0d43696d90f6addae21))
* gate connection handlers on initialization ([f972e28](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/f972e285c6df8248238c35062a2527f0c567b55d))
* gate tab events on initialization ([ce2b4c9](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/ce2b4c9c77934fcaddedeef84929c8ae39d59af2))
* guard auto cleanup retries by activation ([5c64332](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/5c643328e13f0f49b2e0a9b0a97311f39b82fe41))
* guard content lifecycle generations ([0453fb3](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/0453fb389cfda5deaeb13ab1184dfd46865bc1fe))
* guard manual sync relays by epoch ([1c507d6](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/1c507d6e0cdf2f4dc095ed17e2e495ea20269a3c))
* hydrate content sync display details ([3b1aa51](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/3b1aa51ad03983dbd09a166ff4cc60475f232d8d))
* identify auto sync activations ([3ee9962](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/3ee9962685c822d4e34c6a8f374d5b19b427177c))
* identify keyboard manual session messages ([03747b4](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/03747b4ceccbca12d2d978b9c37f8c01513164f1))
* identify reconnect content starts ([5b0129c](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/5b0129c03ea7c7fbc738e75d4651c8684a49af35))
* identify reinjected content starts ([3d5e812](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/3d5e8123c3829bd627f956df5fa43f2a2c25b0da))
* identify suggestion content starts ([21573ff](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/21573ff4b6af6a5a12dc68d873a91e94b86906b8))
* invalidate candidates after accepted suggestions ([9027e64](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/9027e644fdd75da2029dc422f5f232beba681ea1))
* invalidate candidates after popup start ([638dc2f](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/638dc2f18ac872b77d3ecca6627d838281866b61))
* invalidate quick sync candidates on tab lifecycle ([fe7fe94](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/fe7fe941929d1707e24b9f18622dad20e1fcdd8b))
* isolate content status responses ([6cfe2d5](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/6cfe2d53c9bf7b6d316e8ca6eb2ab7863514cdfd))
* isolate synchronized tab details ([cc01aa0](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/cc01aa05241b0642e1c65bbcc623619581fcefee))
* keep quick sync expiration background authoritative ([0a16c58](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/0a16c586f3980ec00eacbe54c3d371376637a4e4))
* lock popup sync control buttons ([c8c5cff](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/c8c5cff1a4fd0129ab1773dc72719aaf5b6f2125))
* map offset recovery outcomes ([843c910](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/843c9108c78c0545f5449dcfb0c56a5d8c3ad03c))
* normalize canonical sync status keys ([9ddacb6](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/9ddacb67d80634bdab23e1c271239de66254bb5f))
* persist pending URL sync hints across worker restarts ([459822b](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/459822b1550ec8f40c3e0c6adf3bafd0613aff40))
* persist repaired sync state before commit ([6a40eb8](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/6a40eb822ee9d55d0dd2803e05eb30a389692289))
* persist runtime reconciliation failures ([e1dca53](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/e1dca53a7cdd341098f111a517dd6897da1fff23))
* prepare quick sync command runtimes ([eba0405](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/eba04059fa6a4fd15f7f971509db001896b616e8))
* preserve authoritative popup sync revision ([e614fac](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/e614fac584b1d1279887bd9d2774bd6515758741))
* preserve auto recovery identities ([c709e99](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/c709e99d7f656b6494713b4e469934d8572fd389))
* preserve auto sync reinjection identities ([43f13d4](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/43f13d4ac31e104009b28f991295ad0f8a0fe661))
* preserve auto sync rollback identities ([ed183ab](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/ed183ab2ce9483e94cf95eb9d898f8ac7c5690d3))
* preserve cross-window popup sync truth ([5776ce9](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/5776ce96348ed374223f2c9cce47481aea33c37d))
* preserve degraded suggestion success ([4e17208](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/4e17208f1717aeed3c65babaf4bdabc9e6526965))
* preserve exact keyboard relay identity ([a14c9b1](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/a14c9b14a93e8c42d12fd74cb5a0223c49112860))
* preserve IME popup shortcut events ([2056e4a](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/2056e4a75367ca736ef06a41219af8798aa9dea6))
* preserve inactive picker height ([7c841f2](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/7c841f2ddbd72a83935300a6497bd7edcae45119))
* preserve latest panel URL sync state ([e99b5e3](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/e99b5e33b5e04e1caf034f15ae8def5e483b8cd0))
* preserve offset reconciliation failures ([220d9f2](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/220d9f2bc1dab39f73e8f89ae8a0cac9bd52eaa4))
* preserve panel tabs when sync status is unavailable ([c8919fc](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/c8919fc3c13ee274c2279930c679505321b77810))
* preserve popup state when sync status is unavailable ([45fb82f](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/45fb82f993638b5ed99a6c60c7ad0ad2d2534103))
* preserve reconnect persistence rejection ([02c6cd4](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/02c6cd4a60e076db1ce8172eedb39d9ae8c869d2))
* preserve reconnect session identity ([9ad3210](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/9ad321037b0517c70c8cb5bbbed29aa9a3ac51e5))
* preserve session identity across tab events ([68492fb](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/68492fb16396813c052182e997d525e6b3b55750))
* preserve truthful panel URL sync authority ([8235839](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/82358391bdb831c98d31ed8e4b5416f44d3e6f24))
* prioritize degraded popup warnings ([f5fad8c](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/f5fad8c28d97738608bd74eaa4c7118f70ba63e2))
* propagate content session identity ([ac8c955](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/ac8c955d2e25149a5c7052e3cb63a57ef5504060))
* protect pending manual overrides ([6840562](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/684056231508d0b56a372dc0d19becd73b721aee))
* reconcile late popup reconnects ([57f2594](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/57f259432066138d97f50c2f2517c32c39ad5664))
* reconcile panel URL sync mode ([e782ed7](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/e782ed70332a1fd0f69751f82d286b19ca611e42))
* reinject quick sync command targets ([42f6510](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/42f6510e1ae805185357f56665034935d17a45a7))
* reject cleanup retries after revision advances ([323f9da](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/323f9da5acfffea86bfe3f661aca17a3e46c2897))
* reject hot relays before manual readiness ([3d37a1b](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/3d37a1b59fa9ba8aaf7e9ae3b1c9cee4a9a4c4ea))
* reject stale auto degradation identities ([cd4cb41](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/cd4cb414848473e63daad80b89739b9e1ba9a2de))
* reject stale auto stop messages ([02798b8](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/02798b8e24b209b93625074dd568b0cdcb5a1544))
* reject stale content relay delivery ([077f74b](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/077f74bd0f79f9b3739d7ff5c6ff32a666665b7a))
* reject stale tab session events ([4210e65](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/4210e656491086da67f41533a53a417b91145d8f))
* remove legacy sync status protocol ([8db1ce2](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/8db1ce25c6cc498e0b5fadd700d05cb4ecb5e755))
* render degraded popup start warnings ([d29e810](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/d29e81054e70ae78dc7dc208893376a7e82c6bf3))
* render generic synced tab rows ([ef74398](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/ef74398805081257f0c2ba81274429b154c8ad7e))
* report degraded staged cleanup ([1845f38](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/1845f381722dcd481c43594a475a352a3bbee5d4))
* report each English locale mismatch ([e56489b](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/e56489be0a3b0c9af75a64e36db6e46725a8c89a))
* report manual offset recovery errors ([20f1b56](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/20f1b56496b2d4a4d7f8dff341cf4a19c19c0724))
* require epochs for manual content starts ([154d5fc](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/154d5fcdceca854e94f76d3f9bb59c4691e22e40))
* reserve cross-worker auto activation identities ([45a8035](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/45a8035f36c5d2d530c2e6d9ce37cf4441b16988))
* respect reduced motion in popup loading state ([bd07215](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/bd07215d888ce3ea27decf233632ee0c2742b47b))
* restore candidates after feedback failure ([1c894bc](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/1c894bc62533adc673026411333a0302f755c0cd))
* restore synchronized tab details ([23842da](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/23842dac7c83a1c06df6bcc2d2f58671a43e606e))
* restore URL sync hints before tab event handling ([5b95a60](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/5b95a60bdc8d91e255354180595bbb04947f1fa6))
* retain candidates on eligible navigation ([3f270d3](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/3f270d35d15b2e353076b78de63c3df7746f2262))
* retry degraded suggestion cleanup ([5800f1a](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/5800f1a76a777be5159027f231020c13ac0a01be))
* revalidate activated tab recovery ([c59ea22](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/c59ea222ce2c2a29a5787b437919d88644929ec5))
* revalidate auto sync recovery identities ([e0ad527](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/e0ad527d994f79a8f0c509a15f49da73aad2664d))
* revalidate keep alive recovery ([e2ef0f0](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/e2ef0f05d48e55bc15ac68e94c137d959fa30270))
* sanitize content panel state ([48aff8e](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/48aff8ee826625266dd0bffb623db2295a83cd81))
* sanitize content sync snapshots ([a95abbd](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/a95abbd9752d547511e48e412cf8e983b52dde1c))
* serialize accepted sync suggestions ([ce0feec](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/ce0feec9e61c2966fffa82fd975183715cda3706))
* serialize runtime auto sync toggles ([bb40c04](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/bb40c049b073cc7ffc75c27af91cc2ad60e2e6bf))
* serialize stored auto sync toggles ([73b06b0](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/73b06b011ab17ac198f75e774f1c1c423c991943))
* share cleanup retry cancellation across runtimes ([6d0aefa](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/6d0aefaeafca6376e637f9b9e073fe85fc0c9966))
* split sync status viewer contracts ([5bba769](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/5bba76933828298440f6a5072c3994acb864e03a))
* stabilize quick sync HUD lifecycle ([d5cd689](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/d5cd6896976d8285fcc994b0b7fde27d48206f8a))
* suppress relayed URL sync echoes ([7783b5d](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/7783b5d134084e65a00844495275ecab783421d6))
* surface degraded quick sync add cleanup ([8135263](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/8135263e5ba00f1753d277f0bad18332d4ba116c))
* terminally abort reserved quick sync candidates ([8779c0a](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/8779c0a41324dd31d84d1dd0ff096324cb440122))
* terminate failed quick sync handshakes ([7946620](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/7946620938f558bd5140a1428c1f76c1732a4a2a))
* tolerate missing shortcut change events ([99de27c](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/99de27c58bd041ef440834b71c31c5a5f7ca9ae4))
* type auto sync activation identities ([fd143ee](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/fd143ee0b7be152cea45884249d398742f81144e))
* type runtime reconciliation identities ([cb4890b](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/cb4890b55c79ff374eff42f5c13cbb44b98f5423))
* use authoritative quick sync failure reasons ([adf6da1](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/adf6da199ca5a0a2b58516ee3f6c219f3ab75f76))
* validate auto sync activation identities ([341a68a](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/341a68a50101d57dd3bc07ac292abd805f3bbea2))
* validate content auto activation identities ([e845fa4](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/e845fa4b505fbaf39843debde9ea9b4c0707f19a))
* validate popup staged stop responses ([0bd74e9](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/0bd74e923351413ae6a2a8c8437f706ee4e96ffb))
* validate quick sync port generation format ([836de27](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/836de2748faf42b12119d454c320ea855a2d7aa3))
* validate restored auto activation identities ([cd13ad0](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/cd13ad078605abd42fd4447641520cda3161d7c1))
* warn panel about degraded cleanup ([910dc3b](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/910dc3b9f0f6ced83988920dc93a8a297e341262))


### Features

* adapt accepted auto-sync groups ([620d36e](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/620d36ef8a1917bc9f5614b602e658ac38defd31))
* add cross-site URL sync examples ([8e5d84c](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/8e5d84c306cd688af7a8eec6970d7158b9e5f070))
* add cross-site URL sync labels ([1efcb0f](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/1efcb0f5df723bbd520206991ee09a13544663aa))
* add quick sync browser shortcut ([#412](https://github.com/jaem1n207/synchronize-tab-scrolling/issues/412)) [skip actions] ([1b71eca](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/1b71ecafae31311b792f4b16025951a609531cc8))
* add quick sync candidate reservations ([dc63f73](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/dc63f73c28b991bd3ae5ee49b161e4ad9a6e3306))
* add quick sync timing helpers ([68a0c5f](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/68a0c5f02903bf6dd911ea2f11ff7b9d0ca01db7))
* branch popup by authoritative session state ([be8d338](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/be8d33848704fd3373dfba79f9444f97d9b1abb0))
* build authoritative sync session snapshots ([11176db](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/11176db6c55e9d1645be9f54cf7791c2bb123899))
* cache manual session epoch in content state ([4e4e0f5](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/4e4e0f5bd9fada091fbaa94545c492f76228ceb4))
* coordinate quick sync decisions ([8892633](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/88926333b196cf16bcb18f1859bd82ccbaf4fb25))
* define exact runtime relay identities ([548e69e](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/548e69ec12275672ec6432c07b6df485834ba584))
* define quick sync feedback contracts ([2e16357](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/2e16357912975adbd8a1c6856922d4772d063523))
* define sync session contracts ([97846c2](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/97846c22d66ce79f55eb7be2f0533fad8152ad85))
* discriminate unavailable manual sync status ([012aff5](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/012aff56b9957fcc5aaf4d157e6204afca13384f))
* explain cross-site URL sync behavior ([21569c5](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/21569c5702492be4c92737f11ad341e16bc853f8))
* expose cross-site URL sync mode ([d2acd34](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/d2acd34f2b283dca31b6e623dc6754f01f573c5e))
* expose degraded start warnings ([b795bab](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/b795bab47c4a4aec22ec1a3df70f2b7c9ba1476a))
* extend content sync display contracts ([68832fb](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/68832fbac680ef266da4dea61f25a3d7aa6433de))
* handle quick sync browser commands ([00c34a8](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/00c34a8b9fc5cf2eb3db1bb8dc090e422efa5aed))
* initialize quick sync feedback before scroll sync ([c30516b](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/c30516bf81fafc672eab68e93cb39b5e8e4ea389))
* localize degraded cleanup in de ([aa653cd](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/aa653cdc9d66b8983e13d821f5eb582e5d021422))
* localize degraded cleanup in es ([6b81c41](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/6b81c41b62e22047566075fa56db78c2b1c177a7))
* localize degraded cleanup in fr ([ef77a3a](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/ef77a3a7b2cbcf6e6d2dd9c3476596ebcd5bce67))
* localize degraded cleanup in hi ([e0751e1](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/e0751e19235282f860b6c7654e23591514d83e10))
* localize degraded cleanup in ja ([0c883c8](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/0c883c86e3a196958122d7c7ade11a32e6fbdcdd))
* localize degraded cleanup in ko ([1f66b94](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/1f66b94c214f8ffd02131896c94d844914321ff8))
* localize degraded cleanup in zh_CN ([9f574e9](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/9f574e91272a941a89967ca75b8099661ad89e12))
* localize degraded cleanup in zh_TW ([d662bec](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/d662bec927a012d1696afabbfbd4d7ab8360e85d))
* localize degraded suggestion cleanup ([96c23dc](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/96c23dc97cf2707e259bf5e1ec195fc3cef89b5b))
* localize generic synced tab label ([ef351d8](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/ef351d8666112b28e9e0baa24771506f3d576816))
* localize generic synced tab label in French ([42b5765](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/42b576536493e4b9da6de29c698bc560f1ce6d8f))
* localize generic synced tab label in German ([8511679](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/85116799304e43824378654bba7e866be9016145))
* localize generic synced tab label in Hindi ([431647f](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/431647f0d0704b892d0cd95f971ac592fb7b42a3))
* localize generic synced tab label in Japanese ([68e65f7](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/68e65f72f9f2b95f7e27e4c925ebeb98b2faff4c))
* localize generic synced tab label in Korean ([bf094f9](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/bf094f93ed82f07a3f665bcd74cafa02c662575e))
* localize generic synced tab label in Simplified Chinese ([63952d4](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/63952d4c9fa6661b2ca81e5b12566b258035cfc0))
* localize generic synced tab label in Spanish ([3214084](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/3214084be146ede45d0329f3ce67d498c90beb45))
* localize generic synced tab label in Traditional Chinese ([5f2c91a](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/5f2c91a1b23b707805aeb99c81d40ec2d0d0f6b1))
* localize quick sync feedback ([8f98519](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/8f985197d51940fa0fb569833a133ea2136f3b41))
* manage quick sync feedback lifecycle ([d758306](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/d7583062e1d17b0eb28d9bf7249636b050708a46))
* manage shortcut from actions ([3fceddd](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/3fcedddd40effb2d376ec68642f5fe945b657a10))
* migrate content panel sync status ([baac7a8](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/baac7a8e114a161ddb56381f3fc02fa8c0388062))
* migrate popup sync status ([922267c](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/922267cf8aa8798f6fdac435507e77e405326a36))
* mount quick sync feedback in page shadow roots ([2ad0f09](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/2ad0f09e2ee1658c820d5c994f191ac711b8e446))
* persist cross-site URL sync mode ([88f0370](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/88f0370f254a449b308bc50aa893489f45dcbcd7))
* read authoritative popup sync sessions ([61b958b](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/61b958b3684df48418fd9d67cf3fc47f579d55ea))
* register quick sync background services ([0001a1a](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/0001a1a3e8b8746ba017b77d5be8ca15810dec90))
* register the quick sync browser command ([ac75d57](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/ac75d577f4908cadd4ddecc3d9104200a50d6333))
* render accessible quick sync feedback ([1893882](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/189388206bf237b57bf8369ead186d48ad8bb8ee))
* render authoritative active sync sessions ([eaf7221](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/eaf72210200d4c5b71d3027d6e52cf090b50c78b))
* require authoritative reconnect refresh ([90aa95a](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/90aa95ac454b25255ff500734648c48739e14687))
* resolve quick sync shortcut settings ([010121f](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/010121f7441df6263152e4124a03df0ddbde8807))
* retry incomplete manual sync cleanup ([c3ddab9](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/c3ddab96d94ad795d5a61a1eaa3d99513d8a5d28))
* reuse target-site URL sync hint ([f596abc](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/f596abcf06cb05509500b3c162547a34f8af70a0))
* serve canonical sync session status ([eedd5d2](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/eedd5d261dbb99d7e6af5e049ab03ec85586dc5c))
* show quick sync shortcut status ([f3b4eb5](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/f3b4eb52c34aded627974ff3c3fb67aa0102ffd2))
* surface recent quick sync failures ([55a4e7b](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/55a4e7b4f422e572dbad66f9eca919622234a672))
* sync page paths across different sites ([#415](https://github.com/jaem1n207/synchronize-tab-scrolling/issues/415)) [skip actions] ([8428fa0](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/8428fa0fe9ccb26bfbf31e0979a54fad8a3f5cc5))
* sync URL paths across unrelated sites ([24d77c0](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/24d77c05789987fd5e3ebda39c072064094c756a))
* track the assigned quick sync shortcut ([d199f37](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/d199f376e90bdb6e97e07e51dc45ed42ea8084ae))
* type canonical sync status requests ([eded574](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/eded57472086e28e0ede058ec6354090c73b9621))
* type degraded suggestion cleanup ([04b1ba6](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/04b1ba69dc9fc86ad89dd13b875d05c23384f797))
* type revision-aware sync lifecycle messages ([7a46c69](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/7a46c690d9ef38258b05e8b171794d3075a295a1))
* type revision-aware sync suggestions ([8d2e28c](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/8d2e28c81d58147a29f763f7ca54a5a00be3ec2f))
* type runtime relay acknowledgements ([f3059a4](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/f3059a40ec8cd05d3abcaad318df2187c459fd83))
* validate auto stop activation identities ([3e025c5](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/3e025c596373a05b5f7157daaecd5c533dd409b1))
* warn about cross-site URL data ([7abcd87](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/7abcd8760ef681a3d5f158d74eb7361858a5bd89))


### Performance Improvements

* expose quick sync content readiness ([ba5154f](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/ba5154f75c1c4118bf7f54cbecb67d37b9afe89a))
* skip stale quick sync ping timeout ([2e3425b](https://github.com/jaem1n207/synchronize-tab-scrolling/commit/2e3425ba8eae0890ff12f112a227864db222105a))
