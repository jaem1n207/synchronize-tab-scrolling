...
팝업을 열지 않고 동기화를 시작하거나 탭을 추가할 수 있습니다.

1. 첫 탭에서 Mac은 Cmd+Shift+., Windows/Linux는 Ctrl+Shift+.를 누릅니다.
2. 10초 안에 다른 탭에서 같은 단축키를 누르면 동기화가 시작됩니다.
3. 동기화 중 다른 탭에서 다시 누르면 해당 탭이 추가됩니다.

단축키는 팝업의 작업 메뉴에서 다시 지정할 수 있습니다.

알려진 제한: 확장 프로그램은 Arc에서도 사용할 수 있지만, Arc가 표준 WebExtension commands.onCommand 이벤트를 전달하지 않아 빠른 동기화 단축키는 지원되지 않습니다. Arc에서는 기존 팝업에서 탭을 선택하고 "동기화 시작"을 누르세요.

자세히: https://github.com/jaem1n207/synchronize-tab-scrolling/blob/main/docs/guides/quick-sync-shortcut.md
...
• 팝업 없이 동기화를 시작하거나 탭을 추가하는 빠른 동기화 단축키
